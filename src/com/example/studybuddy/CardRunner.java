...
public class CardRunner extends Activity implements OnGestureListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
		...
		if (f.exists()) {
			...
			Log.e(FlashcardMain.TAG,"CardRunner cannot start lesson. "+extras.getString("Lesson")+" does not exist");
			finish();
		}
	...
	protected void onSaveInstanceState(Bundle outState) {
		...
		Log.i(FlashcardMain.TAG,"CardRunner Saving State");
						...
						public void onClick(DialogInterface dialog, int whichButton) {
							...
							if (!executeSearch(card_pos,
								...
								if (myMenu.findItem(SEARCH_NEXT_ID) == null)
									myMenu.add(0, SEARCH_NEXT_ID, 1, /*R.string.search_next*/"u");
							}
						}		
					})
