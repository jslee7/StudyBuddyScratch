...
//import com.example.studybuddy.filters.LessonFilter;
...
//		final Button dl_button = (Button) findViewById(R.id.download_button);
	...
	private void doDownload(String _url, String filtClass, String target, String enc) throws Exception {
		...
		String fdest = null;
		if (target != null) 
			fdest = FlashcardMain.sdDir+File.separator+"flashcards/"+target;
		else {
			fdest = url.getFile();
			fdest = FlashcardMain.sdDir+File.separator+"flashcards/"+fdest.substring(fdest.lastIndexOf('/')+1);
		}
